...
/**
 * @see https://www.adventofts.com/events/2023/9
 */
namespace AdventOfTypescript_2023_09 {
  type Reverse<TStr extends string, T = TStr extends `${infer TFirst}${infer TRest}` ? [TFirst, TRest] : ''> =
    T extends [string, string] ? `${Reverse<T[1]>}${T[0]}` : TStr;
